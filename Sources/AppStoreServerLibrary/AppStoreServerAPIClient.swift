...
public class AppStoreServerAPIClient {
    ...
    private func makeRequest<T: Encodable>(path: String, method: HTTPMethod, queryParameters: [String: [String]], body: T?) async -> APIResult<Foundation.Data> {
        do {
            ...
            if response.status.code >= 200 && response.status.code < 300 {
                ...
                return APIResult.failure(statusCode: Int(response.status.code), rawApiError: errorCode, apiError: APIError(rawValue: errorCode), errorMessage: errorMessage, causedBy: nil)
            } else {
    ...
    func executeRequest(_ urlRequest: HTTPClientRequest, _ requestBody: Foundation.Data?) async throws -> HTTPClientResponse {
    ...
    private func makeRequestWithResponseBody<T: Encodable, R: Decodable>(path: String, method: HTTPMethod, queryParameters: [String: [String]], body: T?) async -> APIResult<R> {
        ...
        case let .failure(statusCode, rawApiError, apiError, errorMessage, error):
    ...
    private func makeRequestWithoutResponseBody<T: Encodable>(path: String, method: HTTPMethod, queryParameters: [String: [String]], body: T?) async -> APIResult<Void> {
        ...
        case let .failure(statusCode, rawApiError, apiError, errorMessage, causedBy):
...
public enum APIError: Int64 {
    ...
    case invalidRequestRevision = 4_000_005
    ...
    case invalidTransactionId = 4_000_006
    ...
    case invalidExtendReasonCode = 4_000_010
    ...
    case invalidRequestIdentifier = 4_000_011
    ...
    case startDateTooFarInPast = 4_000_012
    ...
    case startDateAfterEndDate = 4_000_013
    ...
    case invalidPaginationToken = 4_000_014
    ...
    case invalidStartDate = 4_000_015
    ...
    case paginationTokenExpired = 4_000_017
    ...
    case invalidNotificationType = 4_000_018
    ...
    case multipleFiltersSupplied = 4_000_019
    ...
    case invalidTestNotificationToken = 4_000_020
    ...
    case invalidProductType = 4_000_022
    ...
    case invalidProductId = 4_000_023
    ...
    case invalidSubscriptionGroupIdentifier = 4_000_024
    ...
    case invalidExcludeRevoked = 4_000_025
    ...
    case invalidInAppOwnershipType = 4_000_026
    ...
    case invalidEmptyStorefrontCountryCodeList = 4_000_027
    ...
    case invalidAccountTenure = 4_000_032
    ...
    case invalidAppAccountToken = 4_000_033
    ...
    case invalidConsumptionStatus = 4_000_034
    ...
    case invalidCustomerConsented = 4_000_035
    ...
    case invalidDeliveryStatus = 4_000_036
    ...
    case invalidLifetimeDollarsPurchased = 4_000_037
    ...
    case invalidLifetimeDollarsRefunded = 4_000_038
    ...
    case invalidPlatform = 4_000_039
    ...
    case invalidPlayTime = 4_000_040
    ...
    case invalidSampleContentProvided = 4_000_041
    ...
    case invalidUserStatus = 4_000_042
    ...
    case subscriptionMaxExtension = 4_030_005
    ...
    case appNotFoundRetryable = 4_040_004
    ...
    case originalTransactionIdNotFound = 4_040_005
    ...
    case originalTransactionIdNotFoundRetryable = 4_040_006
    ...
    case serverNotificationUrlNotFound = 4_040_007
    ...
    case testNotificationNotFound = 4_040_008
    ...
    case statusRequestNotFound = 4_040_009
    ...
    case transactionIdNotFound = 4_040_010
